        ...
        <SafeAreaView style={{ backgroundColor: "#fff", flex: 1 }}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => {
              ...
              return (<>
                <View style={{ flexDirection: "row", justifyContent: "space-around", alignItems: "center", marginHorizontal: responsiveWidth(4), marginVertical: responsiveHeight(3) }}>
...
export default Show_cuto_measure
